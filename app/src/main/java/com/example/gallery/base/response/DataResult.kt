 ...
 *
 */
package com.example.gallery.base.response

import com.example.gallery.base.response.DataResult
 ...
 */
class DataResult<T>(val result: T, val responseStatus: ResponseStatus) {
